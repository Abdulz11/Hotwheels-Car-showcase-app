...
export default function StartPage() {
  ...
  return (
    ...
    <div className={`absolute t-0 l-0 w-full z-1000  flex justify-center transition-[height] duration-1000 items-start ${num == 100 ? 'h-0':'h-screen'} bg-primary-blue  filter  overflow-hidden`}>
        ...
        <h5 className="font-semi-bold text-[22px] ">The images on this site do not represent the title of the cars.The APIs which offer high quality imagery either require money  or  a company email....both of which I do not have.</h5>
        </div>
    </div>
