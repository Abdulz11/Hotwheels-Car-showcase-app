...
export default function AiCard(prop:{label:string,content:string,image:string}) {
  ...
  return (
    <>
    <div className="flex flex-col items-center md:flex-row space-y-4 md:space-y-0 justify-between min-w-[300px] md:min-w-[900px] md:h-[500px] md:pt-5 md:px-10 px-2  rounded-md  bg-[#F6FAF3] overflow-hidden">
